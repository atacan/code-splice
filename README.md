...
The implementation is organized as a phased build. Phase 1 establishes only the
workspace, domain contracts, documentation, CI, and test foundations; the binary
does not yet expose commands or edit files.
