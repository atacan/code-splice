...
The implementation is organized as a phased build. Through Phase 6, the binary
...
or JSON preview reports. Commit and target-mutating recovery remain explicitly
unavailable.
